...
class CartAndItemModelsTestCase(TestCase):
    ...
    def test_cart_creation(self):
        ...
        self.assertEqual(cart, cart_from_database)
    ...
    def test_item_creation_and_association_with_cart(self):
        ...
        self.assertEqual(item_in_cart.product, user,
        ...
        self.assertEqual(item_in_cart.quantity, 1, 
    ...
    def test_total_item_price(self):
        ...
        self.assertEqual(item_with_unit_price_as_integer.total_price, 300)
        ...
        self.assertEqual(item_with_unit_price_as_decimal.total_price, Decimal("12.80"))
    ...
    def test_update_cart(self):
        ...
        self.assertEqual(cart.summary(), 400)
    ...
    def test_item_unicode(self):
        ...
        self.assertEqual(item.__unicode__(), "3 units of User")
